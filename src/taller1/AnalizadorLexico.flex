...
/* Inicio de Expresiones regulares */
 ...
 Cedula2 = {ComillaAngularIzq}+ {Digito5} | {Digito6} {ComillaAngulaDer}+
 Cedula = {ComillaAngularIzq}+ {Cedula2}{Cedula2}{Cedula2}{Cedula2}{Cedula2}+ {ComillaAngulaDer}+
 ...
 Nombre_Apellido = {ComillaAngularIzq}+ {Letra} {Letra}* {ComillaAngulaDer}+
